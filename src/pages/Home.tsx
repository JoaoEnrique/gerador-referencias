...
export default function Home() {
    ...
    const handleSubmit = (): void => {
        ...
        const { citationTextResult, fullName } = formattName(author);
    ...
    const formattName = (name: string) => {
        const authorNameArray = name.split(" ");
        const lastName = authorNameArray[authorNameArray.length - 1].toUpperCase()
        const firstName = changeToCapitalLetters(authorNameArray.splice(0, authorNameArray.length - 1));
        return {
            citationTextResult: `${lastName}, (${year})`,
